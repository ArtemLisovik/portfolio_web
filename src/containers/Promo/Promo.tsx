            ...
            <div className="info__logo">
                <div className="info__container">
                    ...
                    <h1 className="info__title">
                        <span className="info__title-text">AL 
                            <span className='title__sub'>studio</span>.
                        </span>
                        <span className="info__title-wrapper"></span>
                    </h1>
                    <h2 className="info__subtitle">
                        <span className="info__subtitle-text">Студия веб-разработки <br /></span>
                        <span className="info__subtitle-wrapper"></span>
                    </h2>
                    <div className="info__subtitle-price">
                        {/* <span className="info__subtitle-price-text">Сотрудничайте только с профессионалами</span>
                        <span className="info__subtitle-wrapper"></span> */}
